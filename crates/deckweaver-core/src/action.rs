...
impl ActionState {
    ...
    pub fn get_cached_icon(
        ...
        // Not clamped to 1.0: a source smaller than the slot is scaled up here instead, which is
        // still a single resample from the original rather than a second one.
